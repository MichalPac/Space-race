...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        filtered_df['class'] = filtered_df['class'].map({0: 'Failed', 1: 'Success'})
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        fig = px.scatter(filtered_df,
                         ...
                         title='Success by Payload Mass (kg) for all sites')
        return fig
    else:
        ...
        fig = px.scatter(filtered_df,
                         ...
                         y='class_label',
                         color='Booster Version Category',
                         title=f'Success by Payload Mass (kg) for {entered_site}')
        return fig
